                ...
                function (response) {
                    if (response.errno == 0) {
                        ...
                        if (response.prj.length == 0) {
                            ...
                            $("#myTraceListContent").append('<li class="old_kj_left_box_list_li2" ><a href="javascript:;" onclick="moreTraceRecord()" target="_blank"><span class="old_kj_right_box_list_s1"></span><span class="old_kj_right_box_list_s2 kg_trace_record_btn1" id="kg_trace_record_btn1" >更多追号记录</span><span class="old_kj_right_box_list_s3"></span></a></li>');
                        }
                    }
                    else {
