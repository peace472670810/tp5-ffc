;(function($){
	...
	F.prototype = {
		...
		createHistoryToggle: function(){
			var html = '<div class="history-toggle"><span id="touzhu_jl">投注记录</span><i></i><span id="zhuihao_jl">追号记录</span></div>';
			this.$bar.append(html);
		},
		// 生成游戏玩法tips
		...
		getBalance: function($t){
			...
			$.ajax({
				...
				success:function(data){
					...
					var balance = data ?  data.balance.replace(/,/g,''):0;
                                        balance=balance/1;
