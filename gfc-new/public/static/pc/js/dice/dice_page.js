				...
				k3dice.getServerDynamicConfig(function() {
					...
					if (data['lastballs']) {
						...
						diceAnimation.setBallsNum(lastballs);
                                         ...
                                         $('#J-lottery-info-number').html(newIssueCode);
...
// 顶部用户信息
new phoenix.Hover({
	triggers:'#J-user-panel',
	panels:'#J-user-panel .menu-nav',
	hoverDelayOut:300
});
// 顶部彩种菜单
new phoenix.Hover({
...
/*$('.refreshBall').on('click', function(event){
